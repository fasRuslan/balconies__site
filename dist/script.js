...
var modules = function modules() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        close = document.querySelector(closeSelector); //!Куда нажимать для всплытия popup
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = 'hidden'; // document.body.classList.add('modal-open') //modal-open class bootstrap
      });
    }); //!Кнопка закрыть

    close.addEventListener('click', function (e) {
      modal.style.display = 'none';
      document.body.style.overflow = ""; // document.body.classList.remove('modal-open') //modal-open class bootstrap
...
/* harmony default export */ __webpack_exports__["default"] = (modules); //Экспортируем файл в основной файл
